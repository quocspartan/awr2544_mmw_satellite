...
SECTIONS
{
    ...
    .bss:ENET_DMA_PKT_MEMPOOL  (NOLOAD) {} ALIGN (128) > MSS_L2
...
MEMORY
{
     ...
     */
    MSS_L2     : ORIGIN = 0x10220000 , LENGTH = 0x000C0000

    /* This is typically used to hold data IO buffers from accelerators like HWA */
    DSS_L3:   ORIGIN = 0x88000000, LENGTH = 0x000F0000

    /* Network packet buffer */
    MSS_CPSW_PP:   ORIGIN = 0xC9000000, LENGTH = 0x00001000
}
